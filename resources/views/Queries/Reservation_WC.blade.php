    ...
    <div class="mx-5">
        <table class="table table-striped table-hover table-bordered  tablesorter-dark ">
            ...
            <tbody id='myTable'>
                ...
                @foreach ($ResComp as $Res)
                <tr>
                    <td>{{ $i++ }}</td>

                    <td> {{ $Res->ReservedBy->Nom }}</td>
                    <td> {{ $Res->ReservedBy->Prenom }}</td>
                    <td> {{ $Res->ReservedBy->Fonction ? $Res->ReservedBy->Fonction->label : '' }}</td>
                    <td> {{ $Res->HotelName }}</td>
                    <td> {{ $Res->Type }}</td>
                    <td  {!! $Res->Nbr_Personne=="" ? 'style= "background-color :red"' : '' !!}> {{ $Res->Nbr_Personne }}</td>
                    <td> {{ $Res->From }}</td>
                    <td> {{ $Res->To }}</td>
...
<script>
        ...
        $("table").tablesorter({
            ...
            widgetOptions: {
                ...
                filter_functions: {
                    ...
                    5: {
                        "Single Room": function(e, n, f, i, $r, c, data) {
                            return  e === f;
                        },
                        "Double Room": function(e, n, f, i, $r, c, data) {
                            return  e === f;
                        },
                        "Appartement": function(e, n, f, i, $r, c, data) {
                            return  e === f;
                        }
                    },
    ...
    $('#Pdf').click(function() {
        ...
        doc.setLineWidth(2);
        doc.text(280, 30, `Reservation ${ville} ${type} ${DateNow()}`);
        doc.autoTable({
        ...
        doc.save(`Reservation  ${ville} ${type}  ${DateNow()}.pdf`);
        // location.reload();
    ...
    $("#Export").on("click", function() {
        ...
        $("table").table2excel({
            ...
            filename: `Reservation ${DateNow()}.xls`, // do include extension
